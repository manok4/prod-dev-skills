...
How to research prior art and proven patterns before proposing approaches. Run this after understanding the idea but before proposing solutions.
...
- The general approach taken to solve the problem
- Whether it worked well (based on stars, issues, maintenance activity)
- Key lessons or pitfalls mentioned in their docs or issues
...
**What to extract:**
- What the library does and whether it's mature and maintained
- Whether it's a good fit or overkill for this use case

**Present to user as:**
> "For [task], **[library]** handles this well — [what it does]. It's [actively maintained / widely used]. Alternative: **[library B]** which [trade-off]."
...
- Whether there's a well-known approach for this problem

**Present to user as:**
> "The standard approach for [problem] is [pattern name] — it works by [brief explanation]. Common pitfall: [anti-pattern]."
...
**Relevant libraries:**
- [Library A] — [what it does, good fit or not]
...
- "Based on how [project X] handles this, Option A uses [approach]..."
